// Generated by tools/generate-protocols.mts from Blizzard/heroprotocol (protocol33182.py, blob bd41a273de1eb93d64ff9f25bbdbf9068c3c50be). Do not edit.
...
const protocol: ProtocolDefinition = {
  ...
  typeinfos: [
    ...
    {
      k: 'struct',
      fields: [['m_purchaseItemId', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_difficultyLevel', 84, -1]],
    },
    {
      k: 'choice',
      bounds: [0, 3],
    ...
    {
      k: 'struct',
      fields: [['m_fulfillRequestId', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_cancelRequestId', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_researchItemId', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_mercenaryId', 84, -1]],
    },
    {
      k: 'struct',
      fields: [
    ...
    {
      k: 'struct',
      fields: [['m_result', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_gameMenuItemIndex', 84, -1]],
    },
    {
      k: 'struct',
      fields: [['m_purchaseCategoryId', 84, -1]],
    },
    {
      k: 'struct',
