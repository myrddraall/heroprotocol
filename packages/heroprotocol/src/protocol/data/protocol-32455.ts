// Generated by tools/generate-protocols.mts from Blizzard/heroprotocol (protocol32455.py, blob 77fa0c77eebe7528a456e8cfec1d69ed422dc75c). Do not edit.
...
const protocol: ProtocolDefinition = {
  ...
  typeinfos: [
    ...
    },
    {
      ...
      fields: [
        ['m_lockTeams', 13, -15],
        ['m_teamsTogether', 13, -14],
        ['m_advancedSharedControl', 13, -13],
        ['m_randomRaces', 13, -12],
        ['m_battleNet', 13, -11],
        ['m_amm', 13, -10],
        ['m_ranked', 13, -9],
    ...
    },
    {
      ...
      fields: [
        ...
        ['m_mapSizeX', 10, -15],
        ['m_mapSizeY', 10, -14],
        ['m_mapFileSyncChecksum', 6, -13],
        ['m_mapFileName', 30, -12],
        ['m_mapAuthorName', 9, -11],
        ['m_modFileSyncChecksum', 6, -10],
        ['m_slotDescriptions', 57, -9],
        ['m_defaultDifficulty', 3, -8],
        ['m_defaultAIBuild', 0, -7],
        ['m_cacheHandles', 36, -6],
        ['m_hasExtensionMod', 13, -5],
        ['m_isBlizzardMap', 13, -4],
        ['m_isPremadeFFA', 13, -3],
        ['m_isCoopMode', 13, -2],
        ['m_isArchonMode', 13, -1],
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_subgroupIndex', 95, -4],
        ['m_removeMask', 98, -3],
        ['m_addSubgroups', 100, -2],
        ['m_addUnitTags', 64, -1],
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ['m_count', 95, -6],
        ['m_subgroupCount', 95, -5],
        ['m_activeSubgroupIndex', 95, -4],
    ...
    },
    {
      ...
      fields: [
        ...
        ['m_targetUnitSnapshotUpkeepPlayerId', 109, -3],
        ['m_targetUnitSnapshotControlPlayerId', 109, -2],
        ['m_targetPoint', 110, -1],
      ],
    },
    {
    ...
    {
      k: 'struct',
      fields: [['m_purchaseItemId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_difficultyLevel', 83, -1]],
    },
    {
      k: 'choice',
      bounds: [0, 3],
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_transmissionId', 83, -2],
        ['m_thread', 6, -1],
      ],
    },
    {
      k: 'struct',
      fields: [['m_transmissionId', 83, -1]],
    },
    {
      k: 'optional',
      typeid: 80,
    ...
    {
      k: 'struct',
      fields: [['m_resources', 106, -1]],
    },
    {
      k: 'struct',
      fields: [['m_fulfillRequestId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_cancelRequestId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_researchItemId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_mercenaryId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [
        ['m_battleReportId', 83, -2],
        ['m_difficultyLevel', 83, -1],
      ],
    },
    {
      k: 'struct',
      fields: [['m_battleReportId', 83, -1]],
    },
    {
      k: 'int',
      bounds: [0, 19],
    ...
    {
      k: 'struct',
      fields: [['m_decrementMs', 161, -1]],
    },
    {
      k: 'struct',
      fields: [['m_portraitId', 83, -1]],
    },
    {
      k: 'struct',
    ...
    {
      k: 'struct',
      fields: [['m_result', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_gameMenuItemIndex', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_purchaseCategoryId', 83, -1]],
    },
    {
      k: 'struct',
      fields: [['m_button', 79, -1]],
    },
    {
      k: 'struct',
      fields: [
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_scoreValueMineralsCurrent', 83, 0],
        ['m_scoreValueVespeneCurrent', 83, 1],
        ['m_scoreValueMineralsCollectionRate', 83, 2],
        ['m_scoreValueVespeneCollectionRate', 83, 3],
        ['m_scoreValueWorkersActiveCount', 83, 4],
        ['m_scoreValueMineralsUsedInProgressArmy', 83, 5],
        ['m_scoreValueMineralsUsedInProgressEconomy', 83, 6],
        ['m_scoreValueMineralsUsedInProgressTechnology', 83, 7],
        ['m_scoreValueVespeneUsedInProgressArmy', 83, 8],
        ['m_scoreValueVespeneUsedInProgressEconomy', 83, 9],
        ['m_scoreValueVespeneUsedInProgressTechnology', 83, 10],
        ['m_scoreValueMineralsUsedCurrentArmy', 83, 11],
        ['m_scoreValueMineralsUsedCurrentEconomy', 83, 12],
        ['m_scoreValueMineralsUsedCurrentTechnology', 83, 13],
        ['m_scoreValueVespeneUsedCurrentArmy', 83, 14],
        ['m_scoreValueVespeneUsedCurrentEconomy', 83, 15],
        ['m_scoreValueVespeneUsedCurrentTechnology', 83, 16],
        ['m_scoreValueMineralsLostArmy', 83, 17],
        ['m_scoreValueMineralsLostEconomy', 83, 18],
        ['m_scoreValueMineralsLostTechnology', 83, 19],
        ['m_scoreValueVespeneLostArmy', 83, 20],
        ['m_scoreValueVespeneLostEconomy', 83, 21],
        ['m_scoreValueVespeneLostTechnology', 83, 22],
        ['m_scoreValueMineralsKilledArmy', 83, 23],
        ['m_scoreValueMineralsKilledEconomy', 83, 24],
        ['m_scoreValueMineralsKilledTechnology', 83, 25],
        ['m_scoreValueVespeneKilledArmy', 83, 26],
        ['m_scoreValueVespeneKilledEconomy', 83, 27],
        ['m_scoreValueVespeneKilledTechnology', 83, 28],
        ['m_scoreValueFoodUsed', 83, 29],
        ['m_scoreValueFoodMade', 83, 30],
        ['m_scoreValueMineralsUsedActiveForces', 83, 31],
        ['m_scoreValueVespeneUsedActiveForces', 83, 32],
        ['m_scoreValueMineralsFriendlyFireArmy', 83, 33],
        ['m_scoreValueMineralsFriendlyFireEconomy', 83, 34],
        ['m_scoreValueMineralsFriendlyFireTechnology', 83, 35],
        ['m_scoreValueVespeneFriendlyFireArmy', 83, 36],
        ['m_scoreValueVespeneFriendlyFireEconomy', 83, 37],
        ['m_scoreValueVespeneFriendlyFireTechnology', 83, 38],
      ],
    },
    {
      k: 'struct',
