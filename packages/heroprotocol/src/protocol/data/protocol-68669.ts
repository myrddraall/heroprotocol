// Generated by tools/generate-protocols.mts from Blizzard/heroprotocol (protocol68669.py, blob 9fca2c12112a408d0a63c9f252010d75b41cdf9e). Do not edit.
  ...
  typeinfos: [
    ...
    },
    {
      ...
      fields: [
        ...
        ['m_skin', 46, -14],
        ['m_mount', 46, -13],
        ['m_workingSetSlotId', 25, -12],
        ['m_rewards', 63, -11],
        ['m_toonHandle', 20, -10],
        ['m_tandemLeaderUserId', 60, -9],
        ['m_hasSilencePenalty', 13, -8],
        ['m_hasVoiceSilencePenalty', 13, -7],
        ['m_isBlizzardStaff', 13, -6],
        ['m_banner', 46, -5],
        ['m_spray', 46, -4],
