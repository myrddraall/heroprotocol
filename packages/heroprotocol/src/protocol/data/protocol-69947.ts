// Generated by tools/generate-protocols.mts from Blizzard/heroprotocol (protocol69947.py, blob 2fe322b4b8717e597195f05be7976a17d432af84). Do not edit.
  ...
  typeinfos: [
    ...
    },
    {
      ...
      fields: [
        ...
        ['m_gameDescription', 59, -2],
        ['m_lobbyState', 68, -1],
      ],
    },
    {
      k: 'struct',
      fields: [['m_syncLobbyState', 69, -1]],
    },
    {
      k: 'struct',
      fields: [['m_name', 20, -1]],
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_targetUnitFlags', 80, -7],
        ['m_timer', 10, -6],
        ['m_tag', 6, -5],
        ['m_snapshotUnitLink', 80, -4],
        ['m_snapshotControlPlayerId', 60, -3],
        ['m_snapshotUpkeepPlayerId', 60, -2],
        ['m_snapshotPoint', 89, -1],
      ],
    },
    {
      k: 'choice',
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_transmissionId', 88, -2],
        ['m_thread', 6, -1],
      ],
    },
    {
      k: 'struct',
      fields: [['m_transmissionId', 88, -1]],
    },
    {
      k: 'optional',
      typeid: 81,
    ...
    {
      k: 'struct',
      fields: [['m_decrementMs', 155, -1]],
    },
    {
      k: 'struct',
      fields: [['m_portraitId', 88, -1]],
    },
    {
      k: 'struct',
    ...
    {
      k: 'struct',
      fields: [['m_result', 88, -1]],
    },
    {
      k: 'struct',
      fields: [['m_gameMenuItemIndex', 88, -1]],
    },
    {
      k: 'int',
      bounds: [-32768, 16],
