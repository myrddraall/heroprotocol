// Generated by tools/generate-protocols.mts from Blizzard/heroprotocol (protocol38236.py, blob 457c6234946e71c9883fdffecb9ef923f7f19cee). Do not edit.
...
const protocol: ProtocolDefinition = {
  ...
  typeinfos: [
    ...
    {
      k: 'struct',
      fields: [['m_purchaseItemId', 86, -1]],
    },
    {
      k: 'struct',
      fields: [['m_difficultyLevel', 86, -1]],
    },
    {
      k: 'choice',
      bounds: [0, 3],
    ...
    {
      k: 'struct',
      fields: [['m_fulfillRequestId', 86, -1]],
    },
    {
      k: 'struct',
      fields: [['m_cancelRequestId', 86, -1]],
    },
    {
      k: 'struct',
      fields: [
    ...
    {
      k: 'struct',
      fields: [['m_researchItemId', 86, -1]],
    },
    {
      k: 'struct',
      fields: [['m_mercenaryId', 86, -1]],
    },
    {
      k: 'struct',
      fields: [
        ['m_battleReportId', 86, -2],
        ['m_difficultyLevel', 86, -1],
      ],
    },
    {
      k: 'struct',
      fields: [['m_battleReportId', 86, -1]],
    },
    {
      k: 'int',
      bounds: [0, 19],
    ...
    {
      k: 'struct',
      fields: [['m_purchaseCategoryId', 86, -1]],
    },
    {
      k: 'struct',
    ...
    {
      k: 'struct',
      fields: [['m_target', 87, -1]],
    },
    {
      k: 'struct',
      fields: [['m_target', 88, -1]],
    },
    {
      k: 'struct',
      fields: [
    ...
    },
    {
      k: 'struct',
      fields: [
        ['m_scoreValueMineralsCurrent', 86, 0],
        ['m_scoreValueVespeneCurrent', 86, 1],
        ['m_scoreValueMineralsCollectionRate', 86, 2],
        ['m_scoreValueVespeneCollectionRate', 86, 3],
        ['m_scoreValueWorkersActiveCount', 86, 4],
        ['m_scoreValueMineralsUsedInProgressArmy', 86, 5],
        ['m_scoreValueMineralsUsedInProgressEconomy', 86, 6],
        ['m_scoreValueMineralsUsedInProgressTechnology', 86, 7],
        ['m_scoreValueVespeneUsedInProgressArmy', 86, 8],
        ['m_scoreValueVespeneUsedInProgressEconomy', 86, 9],
        ['m_scoreValueVespeneUsedInProgressTechnology', 86, 10],
        ['m_scoreValueMineralsUsedCurrentArmy', 86, 11],
        ['m_scoreValueMineralsUsedCurrentEconomy', 86, 12],
        ['m_scoreValueMineralsUsedCurrentTechnology', 86, 13],
        ['m_scoreValueVespeneUsedCurrentArmy', 86, 14],
        ['m_scoreValueVespeneUsedCurrentEconomy', 86, 15],
        ['m_scoreValueVespeneUsedCurrentTechnology', 86, 16],
        ['m_scoreValueMineralsLostArmy', 86, 17],
        ['m_scoreValueMineralsLostEconomy', 86, 18],
        ['m_scoreValueMineralsLostTechnology', 86, 19],
        ['m_scoreValueVespeneLostArmy', 86, 20],
        ['m_scoreValueVespeneLostEconomy', 86, 21],
        ['m_scoreValueVespeneLostTechnology', 86, 22],
        ['m_scoreValueMineralsKilledArmy', 86, 23],
        ['m_scoreValueMineralsKilledEconomy', 86, 24],
        ['m_scoreValueMineralsKilledTechnology', 86, 25],
        ['m_scoreValueVespeneKilledArmy', 86, 26],
        ['m_scoreValueVespeneKilledEconomy', 86, 27],
        ['m_scoreValueVespeneKilledTechnology', 86, 28],
        ['m_scoreValueFoodUsed', 86, 29],
        ['m_scoreValueFoodMade', 86, 30],
        ['m_scoreValueMineralsUsedActiveForces', 86, 31],
        ['m_scoreValueVespeneUsedActiveForces', 86, 32],
        ['m_scoreValueMineralsFriendlyFireArmy', 86, 33],
        ['m_scoreValueMineralsFriendlyFireEconomy', 86, 34],
        ['m_scoreValueMineralsFriendlyFireTechnology', 86, 35],
        ['m_scoreValueVespeneFriendlyFireArmy', 86, 36],
        ['m_scoreValueVespeneFriendlyFireEconomy', 86, 37],
        ['m_scoreValueVespeneFriendlyFireTechnology', 86, 38],
      ],
    },
    {
      k: 'struct',
